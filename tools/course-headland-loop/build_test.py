"""Qualify a numbered course-headland test ZIP without changing the live manifest."""
import argparse
import hashlib
...
def build(output):
    ...
    with tempfile.TemporaryDirectory(prefix='course-headland-release-', dir=staging) as temporary:
        ...
        # Run the actual extracted runtime; test harnesses are not shipped in the ZIP.
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output', type=Path, default=ROOT / 'out/course-headland-loop' / BUILD)
